...
import { useHistoryPaymentQuery, useListVerifyPaymentsQuery, useVerifyPaymentMutation } from "@/redux/services/payment";

const { Title } = Typography;

const PaymentsPage = () => {
  const { data: { payload: { data: concerts } = {} } = {}, isLoading } = useHistoryPaymentQuery();
  ...
  return (
    <div>
      <Title level={2}>History Payment</Title>
